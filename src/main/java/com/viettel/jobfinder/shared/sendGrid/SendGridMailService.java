...
public class SendGridMailService {
  ...
  public void sendAcceptedMail(Employer employer, Job job, Employee employee, String message) {
    ...
    String myMessage = message != null ? message : "There is no message";
    String content = "<p><span style=\"font-size: 18px;\">Dear " + employeeName + ",</span></p>\n" +
        ...
        + jobTitle + "</strong> position at <strong>" + companyName
        + "</strong> has been <strong>ACCEPTED</strong>!</span></p>\n" +
        "<p style=\"font-size: 18px;\">Message from company: " + "<strong>" + myMessage + "</strong>" + "</p>\n" +
  ...
  public void sendRejectedMail(Employer employer, Job job, Employee employee, String message) {
    String employeeName = employee.getUser().getFullName();
    String employeeEmail = employee.getUser().getEmail();
    String jobTitle = job.getTitle();
    String companyName = employer.getUser().getFullName();
